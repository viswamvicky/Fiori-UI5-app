		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori App",
									"targetURL": "#comappdemoproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappdemoproject-display": {
								"semanticObject": "comappdemoproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.demoproject",
									"url": sap.ui.require.toUrl("com/app/demoproject")
								}
							}
						}
					}
